...
//        mDivider = new BaseDrawable(createRGBImage(Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_4444), color));  
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        RecyclerView.LayoutManager layoutManager = parent.getLayoutManager();
        if (layoutManager instanceof LinearLayoutManager) {
            SceneLogUtil.e("linear------drawHorizontal");
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        RecyclerView.LayoutManager layoutManager = parent.getLayoutManager();
        if (layoutManager instanceof LinearLayoutManager) {
            SceneLogUtil.e("linear------drawVertical");
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        if (layoutManager instanceof GridLayoutManager || layoutManager instanceof StaggeredGridLayoutManager) {
            SceneLogUtil.e("linear------getItemOffsets");
            ...
            SceneLogUtil.e("linear------getItemOffsetsl");
            if (mOrientation == VERTICAL_LIST) {
                outRect.set(0, 0, 0, mDivider.getIntrinsicHeight());
            } else {
                outRect.set(0, 0, mDivider.getIntrinsicWidth(), 0);
